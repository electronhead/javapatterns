...
class SupremumScalar extends Scalar {

    static final SupremumScalar SUP = new SupremumScalar();
    private static final Supremum value = new Supremum();

    public boolean eq(OrderedDomain element) {
        return element == SupremumScalar.SUP;
    }

    public Supremum getValue() {
        return value;
    }
