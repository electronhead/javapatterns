...
abstract public class OrderedDomainRule extends Object implements Rule {

    abstract public OrderedDomainRule and(OrderedDomainRule rule);

    abstract public OrderedDomainRule or(OrderedDomainRule rule);
}
