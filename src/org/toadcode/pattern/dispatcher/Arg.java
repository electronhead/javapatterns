...
/**
 This class is a convenience class that, when specified in a rule pattern,
 represents the rule corresponding to the type of the corresponding argument
 in a method's argument list.
 */
